...
{% block content %}
 ...
 <div id="content-main">
    ...
    {% if app_list %}
      ...
      {% endfor %}
            <tr>
                <td><a href="/admin/ambienti/" target='blank'>Report scheda Ambienti</a></td>
            </tr><br>
            <tr>
                <td><a href="/admin/strumenti/" target='blank'>Report scheda Strumenti</a></td>
            </tr><br>
            <tr><td><a href="/admin/dipendenti/" target='blank'>Report scheda Dipendenti</a></td></tr><br>
            <tr><td><a href="/admin/schedadescrittiva/" target='blank'>Report scheda descrittiva database</a></td></tr><br>
...
<img id = "box" src="{% static "images/logo.png" %}" alt="Il nostro logo" width="180 px" height="290 px" align="center"/>
  </div>
{% endblock %}
