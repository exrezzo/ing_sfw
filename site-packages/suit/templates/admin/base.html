            ...
            {% if user.is_active and user.is_staff %}
              <div id="user-tools">
                ...
                {% block userlinks %}
                  ...
                  {% endif %}
{#                    <span class="separator">|</span>#}
{#                    <a href='admin/app_index.html'>Documentazione</a>#}
{#                    <span class="separator">|</span>#}
    ...
    <div class="content">
      <div class="tools">
        {% block footer_links %}
          ...
          <a href="mailto:giorgiopapa94@gmail.com" target="_blank" class="icon"><i class="icon-comment"></i>Segnala bug al team di sviluppo</a>
        {% endblock %}
      </div>
